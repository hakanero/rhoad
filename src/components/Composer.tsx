      ...
      {isExpense && (
        <div className="mt-3 flex flex-wrap items-center gap-3">
          ...
          <input type="file" accept="image/*,.pdf"
            ...
            className="text-xs text-muted file:mr-2 file:rounded file:border file:border-line
              file:bg-transparent file:px-2 file:py-1 file:text-xs" />
        </div>
      )}

      {isFreeTier && (
        <div className="mt-3 flex flex-wrap items-center gap-3">
          <Input type="number" step="0.01" min="0" placeholder="becomes 0.00"
