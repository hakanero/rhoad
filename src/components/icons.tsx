...
export const I = {
  ...
  edit: () => wrap(<><path d="M11.5 2.5 13.5 4.5 6 12H4v-2z"/><path d="M10 4l2 2"/></>),
  trash: () => wrap(<><path d="M3 4.5h10M6.5 4.5v-1h3v1M4.5 4.5l.6 8.5h5.8l.6-8.5"/></>),
  menu: () => wrap(<path d="M2.5 4.5h11M2.5 8h11M2.5 11.5h11"/>),
